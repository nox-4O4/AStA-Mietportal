<?php
	...
	return [
		...
		*/
		...
		'in'                   => ":attribute muss ein gültiger Wert sein. (Z.\u{A0}B. einer der vorgegebenen Werte)",
		...
		*/
		...
		'attributes' => [
			...
			'end'                     => 'Ende',
			'eventName'               => 'Veranstaltungsname oder Verwendungszweck',
			'file*'                   => 'Datei',
			'forename'                => 'Vorname',
			...
			'role'                    => 'Rolle',
			'site_notice'             => 'Buchungshinweis',
			'start'                   => 'Beginn',
			'status'                  => 'Status',
			'stock'                   => 'Bestand',
			'street'                  => 'Straße',
			'studying'                => 'Information zum Studium',
			'surname'                 => 'Nachname',
