...
namespace LaravelIdea\Helper\App\Models {
     ...
     * @method Customer createOrRestore(array $attributes = [], array $values = [])
     ...
     * @method Customer restoreOrCreate(array $attributes = [], array $values = [])
     ...
     * @method DisabledDate createOrRestore(array $attributes = [], array $values = [])
     ...
     * @method DisabledDate restoreOrCreate(array $attributes = [], array $values = [])
     ...
     * @method Image createOrRestore(array $attributes = [], array $values = [])
     ...
     * @method Image restoreOrCreate(array $attributes = [], array $values = [])
     ...
     * @method ItemGroup restoreOrCreate(array $attributes = [], array $values = [])
     ...
     * @method OrderItem createOrRestore(array $attributes = [], array $values = [])
